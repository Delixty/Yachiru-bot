...
# Поддержка .env файла (для локального запуска)
try:
...
# ======================== НАСТРОЙКИ ========================
# Токен берётся из переменной окружения (на BotHost: вкладка "Переменные окружения").
# Поддерживаемые имена: TOKEN, DISCORD_TOKEN, BOT_TOKEN
TOKEN = os.getenv("TOKEN") or os.getenv("DISCORD_TOKEN") or os.getenv("BOT_TOKEN") or ""
DATA_FILE = "data.json"
CURRENCY = "🪙"
