...
class Profile(commands.Cog):
    ...
    async def help(self, inter: discord.Interaction):
        e = discord.Embed(title="📖 Команды Yachiru", color=discord.Color.pink())
